...
})(exports.Rounding || (exports.Rounding = {})); // mainnet


var FACTORY_ADDRESS = '0x227044d0cd57e257b15c8c3bd5608e241b8b02ca';
...
var WTRX = (_WTRX = {}, _WTRX[exports.ChainId.MAINNET] = /*#__PURE__*/new Token( // Deployed by Tron Foundation
// https://tronscan.io/#/token20/TNUC9Qb1rRpS5CbWLmNMxXBjyFoydXjWFR/code
exports.ChainId.MAINNET, '0x891cdb91d149f23b1a45d9c5ca78a88d0cb44c18', 6, 'WTRX', 'Wrapped TRX'), _WTRX[exports.ChainId.NILE] = /*#__PURE__*/new Token(exports.ChainId.NILE, '0x6659eaba214be518345a157bd7e1aee20fa64e3d', 6, 'WTRX', 'Wrapped Tron'), _WTRX[exports.ChainId.SHASTA] = /*#__PURE__*/new Token(exports.ChainId.SHASTA, '0xb440ae27ef6b066a1fd2d1bb9c2bb6e61b3373e5', 6, 'WTRX', 'Wrapped Tron'), _WTRX);
...
var Pair = /*#__PURE__*/function () {
  ...
  _proto.getFeeCoefficient = function getFeeCoefficient(tofuFreezedAmount) {
    ...
    !(tofuFreezedAmount.token.address === TOFU_FREEZER_ADDRESS) ?  invariant(false, 'TOFU_FREEZER_ADDRESS')  : void 0;
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === TRX && pairs[0].involvesToken(WTRX[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === TRX && pairs[pairs.length - 1].involvesToken(WTRX[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType, tofuFreezedAmount) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === TRX ? CurrencyAmount.trx(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === TRX ? CurrencyAmount.trx(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
  ...
  currentPairs, originalAmountIn, bestTrades) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountOut.token.equals(tokenOut)) {
        sortedInsert(bestTrades, new Trade(new Route([].concat(currentPairs, [pair]), originalAmountIn.currency, currencyOut), originalAmountIn, exports.TradeType.EXACT_INPUT, tofuFreezedAmount), maxNumResults, tradeComparator);
  ...
  currentPairs, originalAmountOut, bestTrades) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountIn.token.equals(tokenIn)) {
        sortedInsert(bestTrades, new Trade(new Route([pair].concat(currentPairs), currencyIn, originalAmountOut.currency), originalAmountOut, exports.TradeType.EXACT_OUTPUT, tofuFreezedAmount), maxNumResults, tradeComparator);
      } else if (maxHops > 1 && pairs.length > 1) {
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    !!(etherIn && etherOut) ?  invariant(false, 'TRX_IN_OUT')  : void 0;
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, ITofuswapV2Pair.abi, provider).getReserves()).then(function (_ref) {
...
exports.TOFU_FREEZER_ADDRESS = TOFU_FREEZER_ADDRESS;
exports.TRX = TRX;
exports.Token = Token;
...
//# sourceMappingURL=tofuswap-sdk.cjs.development.js.map
